...
Post-P6 implementation-evidence synchronization.
...
- kept P8 phase-gated behind P7 plus real-device/browser QA and production decisions;
...
- preserved the intended green `merge-gate` workflow as normative instead of redefining infrastructure waivers as normal CI behavior;
